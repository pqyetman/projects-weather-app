...
import { calcWindSpeed, filterWeatherString, filterWeather } from './WeatherDataFunctions';
  ...
  return (
    <Card className="text-center" style={{ width: '15rem', background: "transparent", borderColor: "white" }}>      
      ...
      <ListGroup className="list-group-flush">
        ...
        <ListGroup.Item className="bg-transparent border-white text-white">Wind Speed: {loading ? <PlaceHolder size = {6}/> : calcWindSpeed(windSpeed)} {windDirection}</ListGroup.Item>
